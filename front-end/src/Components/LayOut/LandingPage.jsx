            ...
            <div className="themesflat-container w1490">
                ...
                <div className="col-12 pages-title">
                    ...
                    <div data-wow-delay="0.2s" className=" wow fadeInUp flat-button flex justify-center">
                        <a href="#" className="tf-button style-1 h50 w190 mr-16">Discover more <i className="icon-arrow-up-right2" /></a>
                        <a href="#" className="tf-button style-1 h50 w190 active">All collections <i className="icon-arrow-up-right2" /></a>
                    </div>
                    </div>
